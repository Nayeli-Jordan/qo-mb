<?php get_header(); 
	...
	/* Email Header */
    $subject 		 	 = "Entrega de piñata programada";
	...
	$messageHeader 		.= '<p style="margin-bottom: 20px;">Esta es una alerta para recordarte que <span style="color: #de0d88;">el día de mañana</span> está programada la entrega de: <p/>';
