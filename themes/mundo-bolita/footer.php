		<?php if (!is_page('mb-stock')) : ?>
						<section class="container relative margin-top-50">
							...
							<div class="bg-image bg-contain [ absolute top--40p left-15p ] width-20p padding-bottom-20p rotate-180 [ wow flash ]"  data-wow-delay="0.1s"   data-wow-duration="4s" data-wow-iteration="10" style="background-image: url(<?php echo THEMEPATH; ?>images/boli-central.png);"></div>
